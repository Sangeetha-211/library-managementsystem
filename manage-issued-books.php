...
?>
    ...
    <head>
        ...
        <style>
            body {
                background-image: url('assets/img/library-books.jpg');
                                                ...
                                                foreach ($results as $result) {               ?>
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td class="center"><?php if ($result->ReturnDate == "") {
                                                                            ...
                                                                            ?></td>
                                                        <td class="center"><?php if ($result->remark == "") {
                                                                                echo htmlentities("-");
                                                                            } else {
